! function(a) {
    ...
    a.prototype = {
        ...
        initInstragram: function() { dug({ endpoint: "https://api.instagram.com/v1/users/1140781/media/recent/?client_id=01a35e4dd4bf4d2681e48c88d006636e&count=6", target: jQuery("#beta-instagram-feed")[0], cacheExpire: 3600, template: '                            <a href="https://www.facebook.com/hoangtucuagio.luongbaotin" target="_blank">                  <img src="image/products/39939044_158138175070721_4949793149707878400_o.jpg">                </a>            {{/data}}' }) },
